// --- FUNCIONES ESENCIALES PARA EL CARRITO ---
...
    precio_base: 361756
  },
  3: { // Secretos de la Patagonia Norte
...
    imagen: "https://www.gochile.cl/fotos/thumb2/107025-106906-turismo-anuncios-1805-1@2x.jpg",
    descripcion:
      `
...
    precio_base: 85000
  },
  8: { // Carretera Austral – Futaleufú 
    titulo: "Carretera Austral: Rafting en Futaleufú (Día)",
    imagen: "https://storage.googleapis.com/chile-travel-cdn/2021/07/carretera-austral_prin-min.jpg",
    descripcion:
      `
...
    precio_base: 150000
  },
  9: { // Puerto Varas y Saltos del Petrohué 
...
    precio_base: 100000
  },
  10: { // Isla Magdalena – Punta Arenas
...
if (productos[id]) {
  productoSeleccionado = productos[id];
  document.getElementById("titulo").innerText = productoSeleccionado.titulo;
  document.getElementById("imagen").src = productoSeleccionado.imagen;
  
  document.getElementById("descripcion").innerHTML = productoSeleccionado.descripcion;

  const precioFormateado = productoSeleccionado.precio_base.toLocaleString('es-CL', { 
    style: 'currency', 
    currency: 'CLP', 
    minimumFractionDigits: 0
 });
  document.getElementById("precio").innerHTML = `Precio: ${precioFormateado}`;
} else {
  document.getElementById("detalleProducto").innerHTML = "<p class='text-center'>Producto no encontrado. Vuelve a <a href='Productos.html'>Tours</a>.</p>";
}
...
  
  if (!btnAgregarCarrito || !productoSeleccionado) return;

  btnAgregarCarrito.addEventListener("click", () => {
    const nombre = productoSeleccionado.titulo;
    const precio = productoSeleccionado.precio_base;
